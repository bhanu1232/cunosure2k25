...
export default function OfferPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 px-4 backdrop-blur-sm transition-opacity duration-300">
      <div className="relative w-full max-w-md animate-[zoomIn_0.3s_ease-out] overflow-hidden rounded-[2rem] p-[2px]">
        {/* Animated gradient border wrapper */}
        <div
          className="absolute inset-0 animate-[spin_4s_linear_infinite] bg-gradient-to-br from-orange-500 via-purple-500 to-amber-500"
          style={{ backgroundSize: "200% 200%" }}
        />

        {/* Inner Card content */}
        <div className="relative flex size-full flex-col items-center rounded-[calc(2rem-2px)] bg-slate-950/95 p-8 text-center backdrop-blur-xl">
          <button
            onClick={handleClose}
          ...
          <h2 className="mb-2 bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-2xl font-black uppercase tracking-widest text-transparent">
            Flash Offer!
          </h2>

          <h3 className="mb-4 text-xl font-bold text-white">Platinum Combo Pass</h3>

          <p className="mb-6 text-sm leading-relaxed text-white/70">
            Register as a group of <strong className="text-white">3 members</strong> and get full
            access to all Technical and Non-Technical events.
          </p>
          ...
          <div className="mb-8 w-full rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <p className="my-1 text-5xl font-black text-white">₹1500</p>
            <p className="text-xs font-semibold text-white/50">Equivalent to ₹500 per person!</p>
          </div>
