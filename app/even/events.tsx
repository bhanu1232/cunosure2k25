                ...
                <div className="relative bg-n-8 rounded-[20px] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-center justify-between">
                      <Link
                        href="/passes"
                        className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-gradient-to-r from-[#1F4AF6] to-[#1BC7FB] hover:shadow-xl hover:shadow-n-1/10 text-white font-medium transition-all duration-200 group-hover:px-10"
                      >
                        Register Now
                        <svg
