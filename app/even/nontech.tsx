...
const Benefits1 = () => {
  return (
    <Section className="overflow-hidden max-sm:p-0 bg-transparent">
      <div className="container relative z-2 max-sm:px-0 mt-5">
          ...
          <div className="mt-1 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-[1200px] mx-auto px-4 max-sm:px-0">
            {fun.map((item, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="p-[1px] rounded-[20px] bg-gradient-to-r from-[#8F46FF] to-[#FF6B6B] hover:p-[2px] transition-all duration-300">
