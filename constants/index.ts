...
export const events = [
...

  {
    ...
    type: "tech",
    title: "Tech Quiz",
    text: "Test your technical knowledge across various domains in this challenging quiz competition.",
    backgroundUrl: "assets/benefits/card-2.svg",
    iconUrl: benefitIcon2,
    imageUrl: benefitImage2,
    prize: "10000",
  ...
  },
  {
    ...
    type: "tech",
    title: "Web Wreath",
    text: "Create stunning websites under time pressure in this web development competition.",
    backgroundUrl: "assets/benefits/card-4.svg",
    iconUrl: benefitIcon4,
    imageUrl: benefitImage2,
    prize: "12000",
    ...
    - Expert evaluation`,
    rules: [
      "Individual/Pair participation",
      "Original design required",
      "Framework of choice allowed",
      "Live deployment mandatory",
    ],
    requirements: [
      "HTML/CSS/JS skills",
      "Development environment",
