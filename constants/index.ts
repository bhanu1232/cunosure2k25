export const images = {
  ...
  bhanu: "/assets/coord/bhanu.png",
  vivek: "/assets/coord/vivek.jpeg",
  gatatri: "/assets/coord/gayatri.jpeg",
  swaroop: "/assets/coord/swaroop.jpeg",
  pavan: "/assets/coord/pavan.jpg",
  sudhansu: "/assets/coord/sudhansu.jpeg",
  harika: "/assets/coord/harika.jpeg",
  banner: "/banner.avif",
  divya: "/assets/coord/divya.jpeg",
  raahithya: "/assets/coord/raahithya.jpeg",
  balaji: "/assets/coord/balaji.jpeg",
  hemalatha: "/fac/hemalatha.jpeg",
  himachandana: "fac/himachandana.jpeg",
  prasanna: "fac/prasanna.jpeg",
  sreekanth: "fac/sreekanth.jpeg",
  suresh: "fac/suresh.jpeg",
  ramu: "fac/RAMU.jpeg",
  lakshmi: "fac/lakshmi.jpeg",
  dhamu: "fac/dhamu.jpeg",
  kalpana: "fac/kalpana.jpeg",
  vindhya: "fac/vindhya.jpeg",
  chalapati: "fac/chalapati.jpeg",
  muni: "fac/muni.jpeg",
  reddemmay: "fac/reddemmay.jpeg",
};
...
export const collabText =
  "Enter a futuristic arena where technology and strategy collide in a high-stakes robotic showdown. Only the smartest and fastest will dominate!";
...
export const benefits = [
  ...
  },
  {
    id: "3",
    type: "fun",
    title: "Brain Battle Blitz",
    text: "Test your logical thinking and problem-solving skills in this mind-bending challenge.",
...
export const events = [
  {
    ...
    type: "tech",
    title: "Hackathon",
    text: "A 24-hour coding marathon to build innovative solutions. Showcase your creativity and tech prowess in our flagship event! Build prototypes, crack the code, and win big.",
...
Good luck, and may the best team win!`,
  ...
  },
  {
    ...
    type: "tech",
    title: "Tech Quiz",
    text: "Showcase your tech prowess in our interactive Tech Quiz! With real-time leaderboards and mobile integration, it's a fast-paced challenge for the sharpest minds. Individual participation.",
  ...
  },
  {
    ...
    type: "tech",
    title: "Query Clash",
    text: "Master the art of database querying! This two-round event challenges your SQL skills, from basic optimization to complex performance tuning. Compete for cash prizes in the ultimate SQL showdown.",
...

  {
    ...
    type: "tech",
    title: "Blind Coding",
    text: "A unique challenge where you code with the screen off! Test your algorithmic thinking, typing accuracy, and logic as you solve problems without seeing your code. Open to all students.",
    backgroundUrl: "assets/event/blind.avif",
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    prize: "",
    date: "April 5 - 6, 2026",
...

  {
    ...
    type: "tech",
    title: "Spark Tank ",
    text: "Pitch your groundbreaking ideas! Brainstorm and present innovative solutions to real-world challenges. From tech projects to social impact, impress the judges with your creativity and feasibility.",
    ...
    rules: [
      "Rules",
      "1.Participants can compete individually or in teams as per the guidelines.",
      "2.Ideas must be original, innovative, and relevant to the given theme.",
      "3.Teams will have a set time to brainstorm and prepare their presentations.",
      "4.Use of external resources is allowed, but plagiarism will result in disqualification.",
      "5.Presentations must be clear, structured, and within the given time limit.",
      "Judging will be based on creativity, feasibility, impact, and presentation quality.",
    ],
    requirements: [
      "Presentation slides",
...

  {
    ...
    type: "tech",
    title: "Web Wreath",
    text: "Web Wreathe is a competitive event aimed at testing participants proficiency in web development technologies and design skills. Participants will engage in two rounds of challenges that assess their knowledge of HTML, CSS, JavaScript, and their ability to create visually appealing web pages under time constraints.",
    backgroundUrl: "assets/event/web.avif",
    iconUrl: benefitIcon4,
    imageUrl: benefitImage2,
    prize: "3000",
    date: "April 5 - 6, 2026",
    ...
    rules: [
      "Round 1:",
      "HTML, CSS, JavaScript Multiple-choice questions covering HTML, CSS, and JavaScript.Top 60 participants will qualify for the next round.",
      "Round 2:",
      "Web Page Design Challenge Time constraint: Design the complete web page within the specified time. Cash prizes will be awarded to the top two teams demonstrating outstanding performance in the event.",
    ],
    requirements: [
      "HTML/CSS/JS skills",
...

  {
    ...
    rules: [
      ...
      "Shortlisted participants will be notified by April 3rd.",
      ...
      "Reporting time: 10:30 AM, April 5th.",
    ],
    requirements: [
...
export const fun = [
  {
    ...
    rules: [
      "Round 1:",
      "Team Composition: Each team should consist of 2 members. Entry fee: 50 rupees per team. Teams can be formed by contestants or grouped by coordinators randomly.",
      "Round 1: Rapid Response Quiz. Format: MCQ's, Fill-in-the-Blanks. Time Limit: 30 seconds per question. Swift and accurate responses earn higher marks.",
      "A total of 25 questions cover various topics such as movies, sports, riddles, and history. Top 5 teams advance to the next round.",
      "Round 2:",
      "Live Topic Challenge. Teams select topics from a live pool. Each team receives questions specific to their chosen topic. Incorrect answers transfer questions",
    ],
    requirements: [
  ...
  },
  {
    ...
    - Abstract Reasoning`,
    rules: [
      "Round 1: Basic algebra questions involving powers and solving for unknowns.",

      "Round 2: Geometry questions, such as finding area, perimeter, or side lengths.",

      "Round 3: Fun and tricky general reasoning questions, often involving images, that become more challenging as the rounds progress",
    ],
  ...
  },
  {
    ...
    type: "fun",
    title: "Treasure Hunt",
    text: "Embark on an adventure! Follow clues, solve puzzles, and race against time across the campus to find the hidden treasures. Teamwork and quick thinking lead to victory.",
    backgroundUrl: "assets/event/tressure.avif",
    iconUrl: benefitIcon4,
    imageUrl: benefitImage2,
    prize: "",
    date: "April 5 - 6, 2026",
    ...
    rules: [
      "Rules",
      "Participants can compete individually or in teams as per the competition guidelines.",
      "All clues must be followed in sequence to reach the final treasure.",
      "No external help or internet searches are allowed unless specified.",
      "Teams must not interfere with or mislead other participants.",
      "Tampering with or moving hidden clues will lead to disqualification.",
      "The first participant or team to find the final treasure wins the competition.",
    ],
    requirements: [
  ...
  },
  {
    ...
    text: "Capture the moment! Showcase your vision and perspective through your lens in this exciting competition. Submit your best unedited shots during the event period.",
    backgroundUrl: "assets/event/photo.avif",
    iconUrl: benefitIcon2,
    imageUrl: benefitImage2,
    prize: "",
    date: "April 5 - 6, 2026",
    ...
    rules: [
      "Rules:",
      " Participants can use any camera or smartphone.",
      "All photos must be original, unedited, and taken within the competition period.",
      "Each contestant can submit up to three entries.",
      "The theme must be followed, and AI-generated images are not allowed.",
      "Plagiarism or copyright violations will lead to disqualification.",
      "Judging will be based on creativity, composition, and relevance to the theme.",
    ],
    requirements: [
  ...
  },
  {
    ...
    rules: [
      ...
      "Each team will consist of 2-3 participants.",
      "Solve the four locked puzzles by unlocking each box.",
...
export const ESPORTS_EVENTS = [
  {
    ...
    icon: "/freefire.webp",
    title: "Free Fire",
    text: "Join the ultimate Free Fire showdown! Experience intense 4v4 battles in this action-packed mobile gaming tournament. Showcase your tactical skills, team coordination, and strategic gameplay to claim victory and amazing prizes. This is your chance to prove you're the best Free Fire squad!",
    price: "",
    description: "4v4 tactical shooter tournament. Show your skills and strategy.",
    players: "4 players per team",
    schedule: "April 5 - 6, 2026",
    rules: [
      "Tournament Format",
      "Teams must have exactly 4 players",
      "Custom room matches with tournament settings",
      "Double elimination bracket system",
      "Best of 3 matches in playoffs",
      "Finals will be best of 4",

      "General Rules",
      "All players must use their own devices",
      "Players must have Free Fire installed and updated",
      "No emulators allowed - mobile devices only",
      "Team captain must be present 30 minutes before match time",
      "Substitutes are not allowed once tournament begins",

      "Match Rules",
      "Room details will be shared 15 minutes before match",
      "5-minute grace period for technical issues",
      "Screenshots of results must be taken",
      "Fair play and sportsmanship required",
      "Tournament admin decisions are final",
    ],
    requirements: [
      "Mobile device with Free Fire installed",
  ...
  },
  {
    ...
    icon: "/bgmi.jpeg",
    title: "BGMI",
    text: "Enter the battleground in this intense BGMI tournament! Compete against the best teams in thrilling Battle Royale matches where only the strongest survive. Strategic positioning, precise gunplay, and perfect teamwork are your keys to victory. Do you have what it takes to be the last squad standing?",
    price: "",
    ...
    rules: [
      ...
      "General Rules",
      "Only mobile devices allowed (no tablets/iPads)",
      "No emulators or triggers allowed",
      "Players must use their own devices",
      "Team composition cannot be changed mid-tournament",
      "All players must be in the lobby 15 minutes before match",

      "Technical Rules",
      "Game must be updated to latest version",
      "Players responsible for their internet connection",
      "Reconnection allowed within 5 minutes",
      "Screenshots of results required",
      "Tournament admin decisions are final",
    ],
    requirements: [
      "Mobile device with BGMI installed",
      "Stable internet connection",
      "Headphones for communication",
      "Team registration proof",
      "Valid college ID",
    ],
    prize: "",
    coordinators: [
...
export const socials = [
  {
    ...
    title: "Instagram",
    iconUrl: instagram,
    url: "https://www.instagram.com/cynosure_svuce/",
  },
];
...
export const coord = [
  ...
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.hemalatha,
    coordinatorName: "Mrs Hemalatha T",
    contactInfo: "",
    mail: "",
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.himachandana,
    coordinatorName: "Mrs P Himachandana",
    contactInfo: "",
    mail: "",
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.prasanna,
    coordinatorName: "Mr M Lakshmi Prasanna Kumar",
    contactInfo: "",
    mail: "",
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.sreekanth,
    coordinatorName: "Mr J Srikanth Reddy",
    contactInfo: "",
    mail: "",
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.suresh,
    coordinatorName: "Dr K Suresh Kumar Reddy",
    contactInfo: "",
    mail: "",
  },
  {
  ...
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.chalapati,
    coordinatorName: "Mr K Venkata Chalapathi",
    contactInfo: "",
    mail: "",
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.muni,
    coordinatorName: "Ms A Muni Priya",
    contactInfo: "",
    mail: "",
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.vindhya,
    coordinatorName: "Mrs K Vindya Anuragh",
    contactInfo: "",
    mail: "",
  },
  {
    ...
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    coordinatorImage: images.reddemmay,
    coordinatorName: "Mrs Y Reddemma",
    contactInfo: "",
    mail: "",
  },
];
